...
public class JsonUtils {
    ...
    public static <T> T toObjE(Class<? extends T> clazz, String json) throws IOException {
    ...
    public static <T> T toObjE(TypeReference<T> type, String json) throws IOException {
