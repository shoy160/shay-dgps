 ...
 * @author shay
 */
public class Jt808Message<T extends AbstractMessageBody> extends AbstractMessage<T> {

    protected Integer type;
    private Integer bodyProperties;
    private String mobileNumber;
    private Integer serialNumber;

    private Integer subPackageTotal;
    ...
    public Jt808Message(Integer type, String mobileNumber, T body) {
        this.type = type;
        this.mobileNumber = mobileNumber;
        this.body = body;
    }

    public Jt808Message(Integer type, Integer serialNumber, String mobileNumber) {
        this.type = type;
        this.serialNumber = serialNumber;
        this.mobileNumber = mobileNumber;
    }

    public Jt808Message(Integer type, Integer serialNumber, String mobileNumber, T body) {
        this.type = type;
        this.serialNumber = serialNumber;
        this.mobileNumber = mobileNumber;
        this.body = body;
